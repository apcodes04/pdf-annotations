document.addEventListener('DOMContentLoaded', () => {
    ...
    function enableToolbar() {
        ['addTextBtn', 'addImageBtn', 'fixInvertBtn', 'saveBtn'].forEach(id => {
    ...
    addListener('addPdfInput', 'change', async (e) => {
        const file = e.target.files[0];
        if (!file) return;
        ...
        await renderer.appendPDF(arrayBuffer, pdfId, file.name);
    ...
    addListener('addTextBtn', 'click', () => {
        ...
        const fixBtn = document.getElementById('fixInvertBtn');
    ...
    addListener('fixInvertBtn', 'click', () => {
